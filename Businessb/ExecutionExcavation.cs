...
namespace Hazard_Automation.Businessb
{
    ...
    public class ExecutionExcavation

    {
        Document _doc;
        public ExecutionExcavation(Document doc)
        {
            _doc = doc;
        }
        /// <summary>
        ...
        public void HazardPlacement(IList<Element> collection)
        {
            ...
            foreach (var item in collection)
            {
                ...
                if (lp != null)
                {
                    ...
                    //loadHazrdModel.LoadHazrd_Excavations(_doc, newLocationPoint);
                }
            }
        }
        ...
        public void HazardPlacementHeight_RW(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        public void HazardPlacement_single_placement_pile(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();

            ///GetDirection_pile_excavation
            XYZ lp = GetLocation(collection);
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirection_pile_excavation(collection, lp);
                loadHazrdModel.LoadHazrd_Excavations(_doc, newLocationPoint);
            }

        }
        //HazardPlacement_single_placement_Structuralfoundation
        public void HazardPlacement_single_placement_Structuralfoundation(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();

            ///GetDirection_SF_excavation
            XYZ lp = GetLocation(collection);
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirection_SF_excavation(collection, lp);
                loadHazrdModel.LoadHazrd_Excavations(_doc, newLocationPoint);
            }
        ...
        public void HazardPlacementstairs(ICollection<ElementId> collection)
        {
            ...
            foreach (ElementId stairId in collection)
            {
                ...
                foreach (ElementId runId in runIds)
                {
                    ...
                    loadHazrdModel.LoadHazrd_Excavations(_doc, lp);
                }
        ...
        /// <returns></returns>
        private XYZ GetDirection_pile_excavation(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
        ...
        private XYZ GetDirection_SF_excavation(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
            bool gotOrientation = false;
            Sign sign;
