...
{
    public class ExecutionCatastrophic
    {
        Document _doc;
        public ExecutionCatastrophic(Document doc)
        {
            _doc = doc;
        }
        public void HazardPlacement(IList<Element> collection)
        {
            ...
            foreach (var item in collection)
            {
                ...
                if (lp != null)
                {
                    ...
                    loadHazrdModel.LoadHazrd_catsrophe(_doc, newLocationPoint);
                }
            }
        }
        ...
        public void HazardPlacementCatastrophic_pile(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();

            // GetDirectionCatsrop_pile
            XYZ lp = GetLocation(collection);
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirectionCatsrop_pile(collection, lp);
                loadHazrdModel.LoadHazrd_catsrophe(_doc, newLocationPoint);
            }
        }
        public void HazardPlacementCatastrophic_SF(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        public void HazardPlacement_single_placecatastrop(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
            ...
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirectionCatastroph(collection, lp);
                loadHazrdModel.LoadHazrd_catsrophe(_doc, newLocationPoint);
            }
        ...
        public void HazardPlacementstairs(ICollection<ElementId> collection)
        {
            ...
            foreach (ElementId stairId in collection)
            {
                ...
                foreach (ElementId runId in runIds)
                {
                    ...
                    loadHazrdModel.LoadHazrd_catsrophe(_doc, lp);
                }
        ...
        public void HazardPlacement_Catastrop_Exttdoors(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
            ...
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirection_catstrap_Extdoors(collection, lp);
                loadHazrdModel.LoadHazrd_catsrophe(_doc, newLocationPoint);
            }

        }
        //HazardPlacement_Cata_FC
        public void HazardPlacement_Cata_FC(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        private XYZ GetLocationcentroidFS(Element e)
        {
            ...
            if (e is HostObject)
            {
                ...
                foreach (GeometryObject geomObj in geom)
                {
                    ...
                    newPoint = new XYZ(lp.X + 5, lp.Y+25, lp.Z);
        ...
        private XYZ GetDirection_catstrap_Extdoors(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
            bool gotOrientation = false;
            Sign sign;
        ...
        private XYZ GetDirectionCatsrop_pile(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
            bool gotOrientation = false;
            Sign sign;
        ...
        private XYZ GetDirectionCatastroph(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
            bool gotOrientation = false;
            Sign sign;
