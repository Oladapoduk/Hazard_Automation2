...
{
    public class ExecutingHeight
    {
        Document _doc;
        public ExecutingHeight(Document doc)
        {
            _doc = doc;
        }
        public void HazardPlacement(IList<Element> collection)
        {
            ...
            foreach (var item in collection)
            {
                ...
                if (lp != null)
                {
                    ...
                    loadHazrdModel.LoadHazrd_Height(_doc, newLocationPoint);
                }
            }
        }
        ...
        public void HazardPlacementHeight_pile(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();

            //GetDirectionHeight_pile
            XYZ lp = GetLocation(collection);
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirectionHeight_pile(collection, lp);
                loadHazrdModel.LoadHazrd_Height(_doc, newLocationPoint);
            }
        }
        public void HazardPlacementHeight_SF(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
            ...
            if (lp != null)
            {
                XYZ newLocationPoint = GetDirectionHeight_SF(collection, lp);
                loadHazrdModel.LoadHazrd_Height(_doc, newLocationPoint);
            }
        }
        public void HazardPlacementHeight_FS(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //HazardPlacementHeight_RC
        public void HazardPlacementHeight_RC(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //HazardPlacementHeight_RC
        public void HazardPlacementHeight_Roof(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //Rooftimbers
        public void HazardPlacementHeight_Rooftimbers(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //Roofdrainage
        public void HazardPlacementRoofdrainage(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //HazardPlacementHeight_FC
        public void HazardPlacementHeight_FC(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        /// HazardPlacementHeight_WI
        public void HazardPlacementHeight_WI(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        public void HazardPlacementHeight_WE(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        public void HazardPlacementHeight_WF(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //HazardPlacementHeight_WI
        public void HazardPlacementHeight_ff(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        //HazardPlacementHeight_FT
        public void HazardPlacementHeight_FT(Element collection)
        {
            LoadHazrdModel loadHazrdModel = new LoadHazrdModel();
        ...
        public void HazardPlacementstairs(ICollection<ElementId> collection)
        {
            ...
            foreach (ElementId stairId in collection)
            {
                ...
                foreach (ElementId runId in runIds)
                {
                    ...
                    loadHazrdModel.LoadHazrd_Height(_doc, lp);
                }
        ...
        private XYZ GetDirectionHeight_pile(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
            bool gotOrientation = false;
            Sign sign;
            ...
            if (e is FamilyInstance)
            {
                ...
                {
                    if (sign == Sign.Positive)
                        newPoint = new XYZ(locationPoint.X - 23, locationPoint.Y, locationPoint.Z);
                    else if (sign == Sign.Negative)
                        newPoint = new XYZ(locationPoint.X + 23, locationPoint.Y, locationPoint.Z);
                ...
                {
                    if (sign == Sign.Positive)
                        newPoint = new XYZ(locationPoint.X, locationPoint.Y - 31, locationPoint.Z);
                    else if (sign == Sign.Negative)
                        newPoint = new XYZ(locationPoint.X, locationPoint.Y + 31, locationPoint.Z);
                ...
                if (!gotOrientation)
                {
                    ...
                    if (sign == Sign.Positive)
                        newPoint = new XYZ(locationPoint.X - 31.5, locationPoint.Y, locationPoint.Z);
                    else if (sign == Sign.Negative)
                        newPoint = new XYZ(locationPoint.X + 31.5, locationPoint.Y, locationPoint.Z);
                }
            }
        ...
        private XYZ GetDirectionHeight_SF(Element e, XYZ locationPoint)
        {
            XYZ newPoint = null;
            bool gotOrientation = false;
            Sign sign;
